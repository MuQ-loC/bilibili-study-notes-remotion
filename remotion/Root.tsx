...
import { DeepSeekGeneratedVideo, getDeepSeekDurationInFrames } from './DeepSeekGeneratedVideo';
...
export function RemotionRoot() {
  return (
    <>
      ...
      />
      <Composition
        id="DeepSeekGenerated"
        component={DeepSeekGeneratedVideo}
        durationInFrames={getDeepSeekDurationInFrames()}
        fps={FPS}
        width={1920}
        height={1080}
        defaultProps={{}}
